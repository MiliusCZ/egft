...
export class Content extends Component {
    render() {
        const info = 'Vítejte na našem webu.Nabízíme konzultace v oblasti alternativní medicíny, založené na principu epigenetické fytoterapie. Jedná se o propojení nejnovějších vědeckých průzkumů s přírodními superlátkami, které dokáží zvrátit většinu nemocí a to i včetně těch, které jsou považovány za nevyléčitelné.';
                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col-md-4 col-lg-4 text-center infobox">
                                ...
                                <p style={{ width: '15em', marginLeft: 'auto', marginRight: 'auto' }}>
